...
<template>
    <template v-if="tasks?.data?.length || tasksRows?.length">
        <div
                        ...
                        <tr>
                            ...
                            <template v-for="field in $page.props.project?.custom_fields">
                                <th v-if="selectedColumns.includes('custom_fields->'+field.key)"
                                    class="el-table_1_column_4 is-center is-leaf el-table__cell" colspan="1"
                                    rowspan="1">
                                    {{ field.label }}
                                </th>
                            </template>
                            ...
                            <td v-if="selectedColumns.includes('status_id')"
                                ...
                                <div class="cell" style="max-width: 180px; margin: auto;">
                                    <lazy-component>
                                        ...
                                        <!--                    <Transition appear>-->
                                        <el-dropdown v-if="row.status" style="width: 100%;" size="default"
                                                     trigger="click"
                                                     @command="updateTask">
                                            <div v-if="row.status"
                                                 class="status-tag"
                            ...
                            <td v-if="selectedColumns.includes('priority_id')"
                                ...
                                <div class="cell" style="max-width: 150px; margin: auto;">
                                    <lazy-component>
                                        ...
                                        <!--                    <Transition appear>-->
                                        <el-dropdown v-if="row.priority" style="width: 100%;" size="default"
                                                     trigger="click"
                                                     @command="updateTask">
                                            <div v-if="row.priority"
                                                 class="priority-tag"
